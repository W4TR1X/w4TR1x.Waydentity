...
{
    public partial class IdentityManager<TUser, TTenant, TRole, TClaim, TUserId, TTenantId, TRoleId, TClaimId> : IIdentityManager<TUser, TTenant, TRole, TClaim, TUserId, TTenantId, TRoleId, TClaimId>
